...
Para adicionar um novo release, utilize o comando yarn publish para publicar a nova versão.
Certifique-se que seu ambiente windows/linux tenha a variável de ambiente GH_TOKEN com um
